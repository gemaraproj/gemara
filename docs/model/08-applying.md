...
As mentioned in the **Section 3.1: Prior Work**, the *GRC Engineering Model for Automated Risk Assessments* is the product of many previous iterations and learnings. 
